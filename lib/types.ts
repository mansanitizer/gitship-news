...
export const ARTICLE_IMAGES: Record<string, string[]> = {
  ...
  'the-stablecoin-coup-how-tether-became-the-shadow-federal-res': ['24-tether-shadow-reserve.png'],
  'the-certificate-authority-cartel-who-really-controls-the-int': ['25-certificate-cartel.png'],
  'the-npm-dependency-trap-how-6mb-of-left-pad-broke-the-intern': ['26-npm-dependency-trap.png'],
  'the-e-waste-time-bomb-why-your-ai-chip-is-designed-to-die': ['27-ai-chip-obsolescence.png'],
  'the-sam-altman-survival-guide-how-tech-s-most-fired-ceo-keep': ['28-sam-altman-survival.png'],
  'the-vc-aesthetic-why-every-startup-office-looks-like-a-wewor': ['29-vc-aesthetic-wework.png'],
};
